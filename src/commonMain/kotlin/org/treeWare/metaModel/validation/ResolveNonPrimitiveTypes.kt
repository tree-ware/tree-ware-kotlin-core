...
fun resolveNonPrimitiveTypes(
    ...
    val packageErrors = resolvePackages(
        meta,
        rootEntityMeta,
        hasher,
        cipher,
        rootEntityFactory ?: { MutableEntityModel(rootEntityMeta, it) },
        nonPrimitiveTypes
    )
...
private fun resolveAssociationField(
    ...
    resolved.associationMeta = ResolvedAssociationMeta(targetEntityMeta, isRecursive, rootEntityFactory)
