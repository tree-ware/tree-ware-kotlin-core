...
class DifferenceTests {
    ...
    // region Primitive list-field

    @Test
    fun must_not_detect_differences_for_identical_primitive_list_field() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    @Test
    fun must_detect_created_primitive_list_field() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    @Test
    fun must_detect_created_primitive_list_field_amongst_unchanged_fields() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    @Test
    fun must_detect_created_empty_primitive_list_field() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    @Test
    fun must_detect_deleted_primitive_list_field() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    @Test
    fun must_detect_deleted_primitive_list_field_amongst_unchanged_fields() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    @Test
    fun must_detect_deleted_empty_primitive_list_field() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    @Test
    fun must_detect_updated_primitive_list_field_elements() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    @Test
    fun must_detect_updated_primitive_list_field_elements_amongst_unchanged_fields() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    @Test
    fun must_detect_updated_empty_primitive_list_field() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    // region Association list-field

    @Test
    fun must_not_detect_differences_for_identical_association_list_field() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    @Test
    fun must_detect_created_association_list_field() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    @Test
    fun must_detect_created_empty_association_list_field() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    @Test
    fun must_detect_deleted_association_list_field() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    @Test
    fun must_detect_deleted_empty_association_list_field() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    @Test
    fun must_detect_updated_association_list_field_association() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
    ...
    @Test
    fun must_detect_updated_empty_association_list_field() {
        verifyDifference(
            old = """
            |{
            |  "address_book": {
